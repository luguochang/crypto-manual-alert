...
- ADR 0011 已按用户明确的非商业授权要求选择 Aegra 自托管开源 Agent Server，并 supersede ADR 0008 的 hosted 商业推荐。ADR 0008 的区域、网络、Auth、Persistence、HA/SLO、成本和退出项目继续作为生产证据门禁；本地 Compose/Aegra 证据不能替代 hosted/正式环境证明。
